...
namespace MageSuite\ImageOptimization\Test\Unit\Service\Image\CommandLine;
...
class OptimizerTest extends \PHPUnit\Framework\TestCase
{
    public function testItUsesOptimizerLibraryCorrectly()
    {
        ...
        $consoleOptimizer = new \MageSuite\ImageOptimization\Service\Image\CommandLine\Optimizer($optimizerFactoryStub);
